 ...
 * Codex modes: read-only, safe-yolo, yolo, full
 *
 ...
 * - read-only → default
 */
export type PermissionMode = 'default' | 'acceptEdits' | 'bypassPermissions' | 'plan' | 'read-only' | 'safe-yolo' | 'yolo' | 'full'
...
export const MessageMetaSchema = z.object({
  ...
  permissionMode: z.enum(['default', 'acceptEdits', 'bypassPermissions', 'plan', 'read-only', 'safe-yolo', 'yolo', 'full']).optional(), // Permission mode for this message
